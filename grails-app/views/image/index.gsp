		...
		<div id="list-image" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="image.webPage.label" default="Web Page" /></th>
				...
				<g:each in="${imageInstanceList}" status="i" var="imageInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${imageInstance.id}"><img width="50" height="28" src="../upload?filename=${fieldValue(bean: imageInstance, field: "name")}" /></g:link></td>
					
						<td>${fieldValue(bean: imageInstance, field: "webPage")}</td>
